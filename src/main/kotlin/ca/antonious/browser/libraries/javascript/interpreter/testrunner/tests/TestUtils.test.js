test("TestUtils: deepEquals supports primitives", () => {
...
test("TestUtils: deepEquals supports object", () => {
  ...
  expect(deepEquals({ a: 2, b: { c: 3 } }, { b: { d: 3 }, a: 2 })).toBeFalse();
});

test("TestUtils: deepEquals supports arrays", () => {
  expect(deepEquals([], [])).toBeTrue();
