...
sealed class CssTokenType {
    ...
    data class String(override var value: kotlin.String) : CssTokenType(), IdentOrString
    ...
    data class Ident(override var value: kotlin.String) : CssTokenType(), IdentOrString
